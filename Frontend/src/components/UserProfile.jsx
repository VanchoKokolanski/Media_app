...
const randomImg = "https://picsum.photos/1600/900.webp";
      ...
      <div className="flex flex-col pb-5">
        <div className="relative flex flex-col mb-7">
          ...
          {pins?.length ? (
            ...
            <div className="flex justify-center items-center font-bold w-full text-xl mt-2">No pins found</div>
          )}
        </div>
      </div>
    </div>
